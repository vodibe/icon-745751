...
job6_clauses_path = DIR_KB_JOBS / "job6_clauses.pl"
job6_output_path = DIR_KB_JOBS / "job6_output.txt"

# BN
DIR_BIF = DIR_ROOT / "agent" / "pgm" / "bif"

bn_mle_path = DIR_BIF / "__bn_MLE.bif"
bn_map_path = DIR_BIF / "__bn_MAP.bif"

bn_mle_query_path = DIR_BIF / "__bn_MLE_query.txt"
bn_map_query_path = DIR_BIF / "__bn_MAP_query.txt"
