...
BN_CPTS_DEFAULT = [
    # CPT nodi senza genitori
    # TabularCPD(variable='_designer_taste', variable_card=2, values=[[0.5], [0.5]])
    TabularCPD(
        variable="page_template",
        variable_card=9,
        values=[
            [0.111],  # P(page_template=1 | true)
            [0.111],
            [0.111],
            [0.111],
            [0.111],
...
def create_bn(
    ...
    Args:
        location (optional): None se la BN non è stata ancora salvata su file. Altrimenti il percorso. Default: None.
